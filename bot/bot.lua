...
function load_config( )
  ...
  if not f then
    print ("\n🔖┇ جاري انشاء الكونفك :\n🔖┇ خلي ايديك والتوكن واسم البوت ومعرفك كمطور \n🔖┇ V3 وسوف يتم  تشغيل  السورس القيصر توكن الاصدار  ")
    create_config()
  else
    f:close()
  end
